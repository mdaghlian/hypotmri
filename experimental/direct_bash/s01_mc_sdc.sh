#!/bin/bash
#
# FSL motion correction + SDC 
# example usage:
# ./s01_mc_sdc.sh /data/bids /data/derivatives/preproc sub-01 ses-01 pRFRE 
# Runs motion correction per run & SDC
# Uses sbref if available
# Saves the warp file in a way that should be useable later for 
# fmriprep style all-in-one concatenation of transformation
